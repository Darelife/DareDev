  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <section className="min-h-[90vh] flex items-center justify-center" id="home">
        <div className={`flex flex-col lg:flex-row items-center justify-center p-4 lg:p-8 gap-8 lg:gap-16 max-w-6xl mx-auto ${ubuntuMono.className}`}>
          <div
            className={`text-red-500 leading-tight whitespace-pre-wrap text-center text-xs sm:text-sm drop-shadow-[0_0_8px_rgba(255,0,0,0.7)] transition-transform select-none ${!isMobile ? 'cursor-pointer hover:scale-105' : ''
              }`}
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="text-[#e3e3e3] text-3xl md:text-5xl lg:text-6xl transition-all duration-200 text-center lg:text-left drop-shadow-[0_0_8px_rgba(255,0,0,0.7)] selection:bg-red-500 selection:text-black mb-8">
              {displayText}
            </h1>
