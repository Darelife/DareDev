...
`,
  ...
  // Choose frames once per session
  const [pacmanFrames] = useState(() => 
    Math.random() < 0.5 ? rocketFrames : pacmanDefaultFrames
  );
    ...
    <div className="min-h-screen bg-black ">
      ...
      <div className={`mt-20 flex flex-col md:flex-row items-center justify-center p-4 md:p-8 gap-8 md:gap-16 ${ubuntuMono.className}`}>
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-[#e3e3e3] text-2xl md:text-4xl transition-all duration-200 text-center drop-shadow-[0_0_8px_rgba(255,0,0,0.7)]">
            {displayText}
          </h1>
