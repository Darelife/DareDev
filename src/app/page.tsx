...
`,
  ...
  <div className="bg-black">
    <Navbar />
    <div className="min-h-[70vh]" id="home">
      <div className={`mt-20 flex flex-col lg:flex-row items-center justify-center p-4 lg:p-8 gap-6 lg:gap-12 max-w-3xl mx-auto ${ubuntuMono.className}`}>
        <div 
