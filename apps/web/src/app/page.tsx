...
import SketchHero from '@/components/themes/SketchHero';
...
`,
  ...
  return (
    <div className="bg-[var(--appearance-canvas,#000)] min-h-screen">
      <Navbar />

      {/* Hero Section */}
      <section className="home-hero min-h-[90vh] flex items-center justify-center" id="home">
        <SketchHero />
        <div className={`original-hero flex flex-col lg:flex-row items-center justify-center p-4 lg:p-8 gap-8 lg:gap-16 max-w-6xl mx-auto ${ubuntuMono.className}`}>
          <div
            className={`text-[color:var(--appearance-accent,oklch(63.7%_0.237_25.331))] leading-tight whitespace-pre-wrap text-center text-xs sm:text-sm drop-shadow-[0_0_8px_rgba(255,0,0,0.7)] transition-transform select-none ${!isMobile ? 'cursor-pointer hover:scale-105' : ''
              }`}
          ...
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="text-[color:var(--appearance-ink,#e3e3e3)] text-3xl md:text-5xl lg:text-6xl transition-all duration-200 text-center lg:text-left drop-shadow-[0_0_8px_rgba(255,0,0,0.7)] selection:bg-[var(--appearance-highlight,oklch(63.7%_0.237_25.331))] selection:text-[color:var(--appearance-ink,#000)] mb-8">
              {displayText}
            </h1>
            <div className="flex gap-6 justify-center lg:justify-start">
              ...
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="var(--appearance-ink, white)">
